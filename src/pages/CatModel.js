...
const CatModel = () => {
    ...
    <div className="platinum-purr-profiles">
            {[
                 ...
                 { name: "Southpaw 'The Inked' Clawson", age: 4, enjoys: "Getting new ink and pumping iron.", image: "southpaw.png" },
                 { name: "Whiskers 'The Wise' McFur", age: 5, enjoys: "Smoking fine cigars and pondering life's mysteries.", image: "whiskers.png" }
